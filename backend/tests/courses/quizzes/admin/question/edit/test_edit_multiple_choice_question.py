...
class EditMultipleChoiceQuestionTests(TestCasesWithUserAuth):
    def get_api_endpoint(
        ...
        return f"/api/v0/quizzes/admin/{course_slug}/{quiz_slug}/multiple_choice/{coding_question_id}/edit/"
    ...
    def test_happy_path(self):
        ...
        mock_coding_question = create_multiple_choice_question(
            quiz=mock_quiz, correct_option_index=1
        )
        ...
        self.assertEqual(
            mock_coding_question.correct_option_index, updated_correct_option_index
        )
