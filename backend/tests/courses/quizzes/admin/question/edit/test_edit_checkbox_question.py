...
class EditCheckboxQuestionTests(TestCasesWithUserAuth):
    def get_api_endpoint(
        self, course_slug: str, quiz_slug: str, checkbox_question_id
    ) -> str:
        return f"/api/v0/quizzes/admin/{course_slug}/{quiz_slug}/checkbox/{checkbox_question_id}/edit/"
    ...
    def test_happy_path(self):
        ...
        self.assertEqual(
            mock_checkbox_question.correct_option_indices,
            updated_correct_option_indices,
        )
