# Generated by Django 5.1.4 on 2025-03-14 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='courses.quiz')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'quiz'), name='quiz_accommodation_unique_user_quiz')],
            },
        ),
